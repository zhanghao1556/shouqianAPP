...
- 预览渲染校验：逻辑画布 `993 × 1540`，一级设备中心为 `(496.5, 770)`；13 个节点无重叠、无越界，4 个音箱图连续零间距，13 条线路无箭头，页面无横向溢出。正式 `InterfaceWiringPreview` 布局代码尚未修改，等待用户看图确认。
