...
- A three-speaker layout is only a valid odd-count exception when it contains the confirmed symmetric side pair plus one rear-wall center fill in a 13-16m-wide, no-longer-than-10m `front180` room. Other one/three-speaker wall layouts remain special-review cases.
